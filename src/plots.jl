...
function emissiviy_profile_mosaic(SBSrunset::CoronaRunSet, BHrunset::CoronaRunSet; figname)
    ...
    have_three_models([SBSrunset]) || throw(ArgumentError("Boson star runsets must have three models")) 
    has_one_model(BHrunset) || throw(ArgumentError("Black hole runset must have one model")) 
